...
elseif strcmp(HSIName, 'Pavia')

    HSI = load('PaviaU').paviaU;
    GT = load('PaviaU_gt').paviaU_gt;

elseif strcmp(HSIName, 'Botswana')

    HSI = load('Botswana').Botswana; 
    GT = load('Botswana_gt').Botswana_gt; 

elseif strcmp(HSIName, 'KSC')

    HSI = load('KSC').KSC;
    GT = load('KSC_gt.mat').KSC_gt; 
